...
-   **Agent Portal**: Dedicated access for agents to manage their referrals and track ticket statuses.
...
Start the Laravel development server and Vite hot module replacement:

```bash
npm run dev
```

Or if you prefer running them separately:
...
-   **Agents**: System users/referrers who manage accounts and complaints.
-   **Complaints**: Support tickets linked to customers, accounts, and agents.

## Testing

This project uses **Pest PHP** for testing. To run the comprehensive test suite:
