    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Rekening')" class="grid">
                <flux:sidebar.item :href="route('rekening.agents')" :current="request()->routeIs('rekening.agents')"
                    wire:navigate>
                    <x-slot:icon>
                ...
                <flux:sidebar.item :href="route('rekening.customers')"
                    ...
                    <x-slot:icon>
                        <div
                            class="sidebar-icon-wrapper {{ request()->routeIs('rekening.customers') ? 'active' : '' }}">
                            @include('flux::icon.user-circle')
                        </div>
                    </x-slot:icon>
                    <span class="nav-item-text">{{ __('Nasabah') }}</span>
                </flux:sidebar.item>
                <flux:sidebar.item :href="route('rekening.accounts')" :current="request()->routeIs('rekening.accounts')"
                    wire:navigate>
                    <x-slot:icon>
            ...
            <flux:sidebar.group :heading="__('Support')" class="grid">
                <flux:sidebar.item :href="route('rekening.complaints')"
                    :current="request()->routeIs('rekening.complaints')" wire:navigate>
                    <x-slot:icon>
                        <div
                            class="sidebar-icon-wrapper {{ request()->routeIs('rekening.complaints') ? 'active' : '' }}">
                ...
                <flux:sidebar.item :href="route('rekening.shipments')"
                    :current="request()->routeIs('rekening.shipments')" wire:navigate>
                    <x-slot:icon>
                        <div
                            class="sidebar-icon-wrapper {{ request()->routeIs('rekening.shipments') ? 'active' : '' }}">
                            @include('flux::icon.truck')
                        </div>
                    </x-slot:icon>
                    <span class="nav-item-text">{{ __('Shipment') }}</span>
                </flux:sidebar.item>
                <flux:sidebar.item :href="route('rekening.notes')" :current="request()->routeIs('rekening.notes')"
                    wire:navigate>
                    <x-slot:icon>
            ...
            @if(auth()->check() && auth()->user()->hasRole('Super Admin'))
                <flux:sidebar.group :heading="__('Administration')" class="grid">
                    <flux:sidebar.item :href="route('rekening.users')" :current="request()->routeIs('rekening.users')"
                        wire:navigate>
                        <x-slot:icon>
                    ...
                    <flux:sidebar.item :href="route('rekening.roles')" :current="request()->routeIs('rekening.roles')"
                        wire:navigate>
                        <x-slot:icon>
                    ...
                    <flux:sidebar.item :href="route('rekening.permissions')"
                        :current="request()->routeIs('rekening.permissions')" wire:navigate>
                        <x-slot:icon>
                            <div
                                class="sidebar-icon-wrapper {{ request()->routeIs('rekening.permissions') ? 'active' : '' }}">
                                @include('flux::icon.key')
                            </div>
                        </x-slot:icon>
                        <span class="nav-item-text">{{ __('Permissions') }}</span>
                    </flux:sidebar.item>
                    <flux:sidebar.item :href="route('rekening.backups')" :current="request()->routeIs('rekening.backups')"
                        wire:navigate>
                        <x-slot:icon>
        ...
        <flux:sidebar.nav>
            ...
            <div x-data="{ darkMode: document.documentElement.classList.contains('dark') }"
                ...
                <flux:sidebar.item x-show="!darkMode"
                    x-on:click="darkMode = true; document.documentElement.classList.add('dark'); localStorage.theme = 'dark';"
                ...
                <flux:sidebar.item x-show="darkMode"
                    x-on:click="darkMode = false; document.documentElement.classList.remove('dark'); localStorage.theme = 'light';"
